...
# tunnusten hakeminen valvomon holvista
...
def robot_spare_bin_python():
    ...
    browser.configure(
        # halutessa hidastus ja headless päälle/pois
        # slowmo=100,
        headless=True
    )
...
def open_the_intranet_website():
    """Navigates to the URL ('intranet') """
    browser.goto("https://robotsparebinindustries.com/")

def log_in():
    """Fills in the login form and clicks the 'Log in' button"""
    page = browser.page()
    # tunnusten valvomon holvista
    page.fill("#username", _secret["username"])
    page.fill("#password", _secret["password"])
